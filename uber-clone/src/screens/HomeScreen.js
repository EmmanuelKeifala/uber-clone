...
import {colors, parameters, SCREEN_WIDTH} from '../globals/style';
...
const HomeScreen = ({navigation}) => {
  ...
  hours = hours % 12 || 12;
  let time = numberToWords(hours);
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <View style={styles.icon1}>
          <Icon name="menu" type="material" color={colors.white} size={40} />
        </View>
      </View>
      <ScrollView bounces={false}>
        ...
        <View style={styles.view3}>
          ...
          <View style={styles.view4}>
            <Icon
              name={`clock-time-${!time ? time : 'four'}`}
          ...
          <View style={styles.view6}>
            ...
            <View>
              <Text style={{fontSize: 18, color: colors.black}}>
                2 Fornah Sesay Drive
              </Text>
              <Text style={{fontSize: 18, color: colors.grey3}}>Connaught</Text>
            </View>
          </View>
          <View>
            <Icon
...
const styles = StyleSheet.create({
  ...
  card: {
    alignItems: 'center',
    margin: Dimensions.get('screen').width / 22,
  },
