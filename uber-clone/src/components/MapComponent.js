    ...
    return (
      <View>
        <MapView
          ...
          ref={this._map}>
          <Marker
            coordinate={{latitude: 8.438929, longitude: -13.214519}}
            anchor={{x: 0.5, y: 0.5}}>
            <Image
          ...
          <Marker
            coordinate={{latitude: 8.440463, longitude: -13.21805}}
            anchor={{x: 0.5, y: 0.5}}>
            <Image
              source={require('../../assets/location.png')}
          ...
          <MapViewDirections
            origin={{latitude: 8.438929, longitude: -13.214519}}
            destination={{latitude: 8.440463, longitude: -13.21805}}
            apikey={''}
            strokeWidth={4}
